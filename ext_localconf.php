...
$GLOBALS['TYPO3_CONF_VARS']['SC_OPTIONS']['tslib/class.tslib_content.php']['typolinkLinkHandler']['happy_feet'] = 'EXT:' . $_EXTKEY . '/Classes/Service/LinkHandler.php:&Tx_HappyFeet_Service_LinkHandler';